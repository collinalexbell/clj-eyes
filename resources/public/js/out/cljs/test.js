...
var args23571 = [];
var len__22777__auto___23575 = arguments.length;
var i__22778__auto___23576 = (0);
while(true){
if((i__22778__auto___23576 < len__22777__auto___23575)){
args23571.push((arguments[i__22778__auto___23576]));

var G__23577 = (i__22778__auto___23576 + (1));
i__22778__auto___23576 = G__23577;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,G__23574,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23574;
}
});
...
var or__21707__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__22777__auto___23582 = arguments.length;
var i__22778__auto___23583 = (0);
while(true){
if((i__22778__auto___23583 < len__22777__auto___23582)){
args__22784__auto__.push((arguments[i__22778__auto___23583]));

var G__23584 = (i__22778__auto___23583 + (1));
i__22778__auto___23583 = G__23584;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__22785__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23579){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__23580,G__23581,seq23579__$2);
});
...
var file = cljs.core.get.call(null,map__23588__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23588__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23588__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__23588,map__23588__$1,file,line,column){
return (function (p1__23585_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23585_SHARP_));
});})(map__23588,map__23588__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__22632__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__22632__auto__,prefer_table__22633__auto__,method_cache__22634__auto__,cached_hierarchy__22635__auto__,hierarchy__22636__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__21707__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__21707__auto__)){
return or__21707__auto__;
} else {
...
var temp__4657__auto___23590 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___23590)){
var message_23591 = temp__4657__auto___23590;
cljs.core.println.call(null,message_23591);
} else {
}
...
var temp__4657__auto___23592 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___23592)){
var message_23593 = temp__4657__auto___23592;
cljs.core.println.call(null,message_23593);
} else {
}
...
var temp__4655__auto__ = (function (){var and__21695__auto__ = typeof exception.stack === 'string';
if(and__21695__auto__){
var G__23599 = exception.stack;
var G__23599__$1 = (((G__23599 == null))?null:clojure.string.split_lines.call(null,G__23599));
var G__23599__$2 = (((G__23599__$1 == null))?null:cljs.core.get.call(null,G__23599__$1,depth));
if((G__23599__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23599__$2);
}
} else {
...
var vec__23600 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23600,(0),null);
var column = cljs.core.nth.call(null,vec__23600,(1),null);
var vec__23601 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23601,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23601,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23601,(2),null);
...
var m__$1 = (function (){var G__23603 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__23603) {
case "fail":
...
var G__23609 = (function (){var G__23608 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23608);
} else {
return G__23608;
}
})();
...
return cljs.core.vary_meta.call(null,G__23611,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e23614){var e = e23614;
var G__23615 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__23615) {
...
var vec__23618 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23618,(0),null);
var types = vec__23618;
...
return cljs.core.map.call(null,(function (p__23626){
var vec__23627 = p__23626;
var ns = cljs.core.nth.call(null,vec__23627,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__23627,(1),null);
return ((function (vec__23627,ns,vars__$1){
return (function (){
...
var G__23628 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__23628) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1){
return (function (){
var seq__23629 = cljs.core.seq.call(null,vars__$1);
var chunk__23630 = null;
var count__23631 = (0);
var i__23632 = (0);
while(true){
if((i__23632 < count__23631)){
var v = cljs.core._nth.call(null,chunk__23630,i__23632);
var temp__4657__auto___23634 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___23634)){
var t_23635 = temp__4657__auto___23634;
each_fixture_fn.call(null,((function (seq__23629,chunk__23630,count__23631,i__23632,t_23635,temp__4657__auto___23634,v,each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23635)));
});})(seq__23629,chunk__23630,count__23631,i__23632,t_23635,temp__4657__auto___23634,v,each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1))
);
} else {
}

var G__23636 = seq__23629;
var G__23637 = chunk__23630;
var G__23638 = count__23631;
var G__23639 = (i__23632 + (1));
seq__23629 = G__23636;
chunk__23630 = G__23637;
count__23631 = G__23638;
i__23632 = G__23639;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__23629);
if(temp__4657__auto__){
var seq__23629__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23629__$1)){
var c__22518__auto__ = cljs.core.chunk_first.call(null,seq__23629__$1);
var G__23640 = cljs.core.chunk_rest.call(null,seq__23629__$1);
var G__23641 = c__22518__auto__;
var G__23642 = cljs.core.count.call(null,c__22518__auto__);
var G__23643 = (0);
seq__23629 = G__23640;
chunk__23630 = G__23641;
count__23631 = G__23642;
i__23632 = G__23643;
continue;
} else {
var v = cljs.core.first.call(null,seq__23629__$1);
var temp__4657__auto___23644__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___23644__$1)){
var t_23645 = temp__4657__auto___23644__$1;
each_fixture_fn.call(null,((function (seq__23629,chunk__23630,count__23631,i__23632,t_23645,temp__4657__auto___23644__$1,v,seq__23629__$1,temp__4657__auto__,each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23645)));
});})(seq__23629,chunk__23630,count__23631,i__23632,t_23645,temp__4657__auto___23644__$1,v,seq__23629__$1,temp__4657__auto__,each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1))
);
} else {
}

var G__23646 = cljs.core.next.call(null,seq__23629__$1);
var G__23647 = null;
var G__23648 = (0);
var G__23649 = (0);
seq__23629 = G__23646;
chunk__23630 = G__23647;
count__23631 = G__23648;
i__23632 = G__23649;
continue;
}
} else {
...
});})(each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1))
);
});})(each_fixture_fn,G__23628,env,once_fixtures,each_fixtures,vec__23627,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1466050378827