...
*** TODO Refactor code that handles params into param-handling.cljs
*** TODO Get optional parameters to show when I click on them. 
**** Some optional parameters are tied together, so they must be activated together.
